package de.meisl.showcase.views.main;
...
public class MainView extends AppLayout {
    ...
    private Component createDrawerContent(Tabs menu) {
        ...
        logoLayout.add(new Image("images/logo.png", "Vaadin Showcase logo"));
        logoLayout.add(new H1("Vaadin Showcase"));
    ...
    private Tab[] createMenuItems() {
        return new Tab[]{
                ...
                createTab("Container List", ContainerListView.class)
        };
    }
